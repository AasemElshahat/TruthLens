...
\begin{otherlanguage}{ngerman} 
    ...
    Die qualitative Analyse identifiziert drei zentrale Fehlermodi: die Ablehnung kontextabhängiger Behauptungen, ineffektive Suchanfragen sowie Schwierigkeiten mit unterrepräsentierten Klassen. Trotz dieser Einschränkungen erreichen die Modelle bei 69\% der Verifikationsaufgaben einstimmige Korrektheit. Dies zeigt, dass LLM-basierte Faktenprüfung für eindeutige faktische Behauptungen praktische Zuverlässigkeit erreicht hat.
...
\label{ch:background}
    ...
    \end{enumerate}
    The authors of the SAFE framework \cite{SAFE2024} demonstrated that LLM agents using this method can outperform human crowdsourced annotators in rating long-form factuality, achieving superior performance in terms of both accuracy and cost-effectiveness. The TruthLens framework incorporates the SAFE-based verification agent from the ClaimeAI repository.

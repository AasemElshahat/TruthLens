...
%         \textbf{\Huge A Comparative Analysis of Large Language Models (GPT-4o-mini, Gemini-2.5-Flash, DeepSeek-V3.2) for Factual Claim Extraction and Verification}
...
\section{Objective and Research Questions}
    ...
    \begin{table}[ht]
        ...
        \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{2.5cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}X|}
            ...
            \hline
            DeepSeek & DeepSeek-V3.2.2 & \texttt{deepseek-chat} (V3.2 API) \\ 
            \hline
        \end{tabularx}
...
\label{ch:methodology}
    ...
    \begin{itemize}
        \item \textbf{Multi-Provider Abstraction:} Refactoring the underlying LLM interface to support the execution of Gemini-2.5-Flash and DeepSeek-V3.2 models alongside OpenAI.
...
\begin{table}[ht]
    \centering
    \caption{Extraction Phase Sample: Argentine Tango Sentence (From my\_thesis\_dataset\_run1.csv)}
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        \textbf{Original Sentence} & ``The Argentine tango is a dance and musical form that originated \\
        & in Buenos Aires in the late 19th century, and has since become \\
        & a revered art form worldwide.'' \\
        \hline
...
\begin{table}[ht]
    \centering
    \caption{Verification Phase Sample: Argentine Tango Claim (From my\_thesis\_benchmark\_claims\_run1.csv)}

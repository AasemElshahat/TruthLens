...
\section{Objective and Research Questions}
    ...
    The primary objective of this thesis is to perform a comparative analysis of three modern Large Language Models—\textbf{gpt-4o-mini}, \textbf{gemini-2.5-flash}, and \textbf{deepseek-v3.2}—to determine their efficacy in an automated fact-checking pipeline.
...
A comprehensive reproduction guide (\texttt{REPRODUCTION\_GUIDE.md}) is included in the repository, providing step-by-step instructions for:
\begin{itemize}

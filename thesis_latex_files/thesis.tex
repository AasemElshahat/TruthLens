...
\label{ch:background}
    ...
    Once atomic claims are extracted, they must be verified against external evidence. Relying on an LLM's internal parametric knowledge (facts encoded in model weights during training) is insufficient due to the ``knowledge cutoff'' problem and the risk of reinforcing existing hallucinations.
